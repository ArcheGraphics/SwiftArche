...
public enum VertexPositioning {
    ...
    public static func VerticesInWorldSpace(mesh _: ProBuilderMesh) -> [Vector3] {
        []
    }
    ...
    public static func TranslateVerticesInWorldSpace(for _: ProBuilderMesh, indexes _: [Int], offset _: Vector3) {}
    ...
    internal static func TranslateVerticesInWorldSpace(for _: ProBuilderMesh,
                                                       indexes _: [Int],
                                                       offset _: Vector3,
                                                       snapValue _: Float,
                                                       snapAxisOnly _: Bool) {}
    ...
    ///   - indexes: A set of triangles pointing to the vertex positions that are to be affected.
    ///   - offset: offset
    public static func TranslateVertices<T: Sequence<Int>>(for _: ProBuilderMesh, indexes _: T, offset _: Vector3) {}
    ...
    ///   - offset: offset
    public static func TranslateVertices<T: Sequence<Edge>>(for _: ProBuilderMesh, edges _: T, offset _: Vector3) {}
    ...
    ///   - offset: offset
    public static func TranslateVertices<T: Sequence<Face>>(for _: ProBuilderMesh, faces _: T, offset _: Vector3) {}

    static func TranslateVerticesInternal<T: Sequence<Int>>(for _: ProBuilderMesh, indices _: T, offset _: Vector3) {}
    ...
    public static func SetSharedVertexPosition(for _: ProBuilderMesh, sharedVertexHandle _: Int, position _: Vector3) {}

    /// Set a collection of mesh attributes with a Vertex.
    /// Use @"UnityEngine.ProBuilder.ProBuilderMesh.sharedIndexes" and IntArrayUtility.IndexOf to get a shared (or common) index.
    internal static func SetSharedVertexValues(for _: ProBuilderMesh, sharedVertexHandle _: Int, vertex _: Vertex) {}
}
