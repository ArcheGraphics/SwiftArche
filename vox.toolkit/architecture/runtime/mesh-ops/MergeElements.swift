...
public enum MergeElements {
    ...
    public static func MergePairs(target _: ProBuilderMesh, pairs _: [(Face, Face)],
                                  collapseCoincidentVertices _: Bool = true) -> [Face]
    {
        []
    }
    ...
    public static func Merge<T: Sequence<Face>>(target _: ProBuilderMesh, faces _: T) -> Face {
        Face()
    }
    ...
    internal static func CollapseCoincidentVertices<T: Sequence<Face>>(mesh _: ProBuilderMesh, faces _: T) {}
}
