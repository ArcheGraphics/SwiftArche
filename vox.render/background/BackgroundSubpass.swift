...
public class BackgroundSubpass: Subpass {
    private var _textureFillMode: BackgroundTextureFillMode = .AspectFitHeight
    ...
    func prepare(pipeline _: DevicePipeline, on encoder: MTLRenderCommandEncoder) {
    ...
    override public func draw(pipeline: DevicePipeline, on encoder: inout RenderCommandEncoder) {
