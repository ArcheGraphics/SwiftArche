...
final class Bounds2D {
    ...
    var m_Size: Vector2 = Vector2.zero;
    var m_Extents: Vector2 = Vector2.zero;
    ...
    internal init(points: [Vector3], edges: [Edge]) {}
    
    public init(points: [Vector2], length: Int) {}
    
     /// Returns true if the point is contained within the bounds.  False otherwise.
    public func ContainsPoint(_ point: Vector2) -> Bool {
        false
    }

     /// Returns true if any part of the line segment is contained within this bounding box.
    public func IntersectsLineSegment(from lineStart: Vector2, to lineEnd: Vector2) -> Bool {
        false
    }
    
    /// Returns true if bounds overlap.
    public func Intersects( bounds: Bounds2D) -> Bool {
        false
    }
    ...
    public func SetWithPoints(_ points: [Vector2]) {}
    
    /// Set this bounds center and size to encapsulate points.
    public func SetWithPoints(_ points: [Vector2], indexes: [Int]) {}
    ...
    public static func Center(points: [Vector2]) -> Vector2 {
        Vector2()
    }
    
    public static func Center(points: [Vector2], indexes: [Int]) -> Vector2 {
        Vector2()
    }
    
    public static func Size(points: [Vector2], indexes: [Int]) -> Vector2{
        Vector2()
    }
    
    internal static func Center(points: [Vector4], indexes: [Int]) -> Vector2 {
        Vector2()
    }
}
