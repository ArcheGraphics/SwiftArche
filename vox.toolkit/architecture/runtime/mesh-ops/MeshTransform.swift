...
public class MeshTransform {
    ...
    internal static func SetPivot(mesh: ProBuilderMesh, pivotLocation: PivotLocation) {
    }
    ...
    public static func CenterPivot(mesh: ProBuilderMesh, indexes: [Int]) {
    }
    ...
    public static func SetPivot(mesh: ProBuilderMesh, worldPosition: Vector3) {
    }

    /// Scale vertices and set transform.localScale to Vector3.one.
    /// - Parameter mesh: The target mesh.
    public static func FreezeScaleTransform(mesh: ProBuilderMesh) {
    }
}
