...
public struct BurstCapsule: IDistanceFunction, IBurstCollider {
    ...
    func Contacts(colliderIndex _: Int, rigidbodyIndex _: Int, rigidbodies _: [BurstRigidbody],
                  ...
                  radii _: [float4], simplices _: [Int], simplexBounds _: BurstAabb, simplexIndex _: Int,
                  simplexStart _: Int, simplexSize _: Int, contacts _: [BurstContact],
