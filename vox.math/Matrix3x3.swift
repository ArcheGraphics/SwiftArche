...
extension Matrix3x3 {
    ...
    public mutating func set(m11: Float, m12: Float, m13: Float,
    ...
    /// - Returns: This matrix
    public mutating func set(array: Array<Float>, offset: Int = 0) -> Matrix3x3 {
        var index = 0
        for i in 0..<3 {
            for j in 0..<3 {
    ...
    public mutating func set(a: Matrix) -> Matrix3x3 {
